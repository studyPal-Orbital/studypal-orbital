...
describe('User can type out tasks on a sticky note', () => {
    ...
    it('User can pop bubbles', () => {
      cy.get('[data-cy="nav-to-bubbles"]').click()
      cy.get('[data-cy="bubble-wrap"]').contains("Bubble Wrap")
      cy.get('[data-cy="bubble"]').eq(0).click()
      cy.get('[data-cy="nav-bubble-to-forum"]').click()
    })
})