...
const Tooltip = (_a) => {
    var { className, children, content, triggerClassName, disabled, enterDelay, leaveDelay, placement, trigger, visible, followCursor, closeOnClick, closeOnEscape, closeOnBodyClick, pointerEvents } = _a, rest = __rest(_a, ["className", "children", "content", "triggerClassName", "disabled", "enterDelay", "leaveDelay", "placement", "trigger", "visible", "followCursor", "closeOnClick", "closeOnEscape", "closeOnBodyClick", "pointerEvents"]);
    ...
    return (jsxRuntime.jsx(rdk.ConnectedOverlay, Object.assign({}, rest, { placement: placement, trigger: trigger, followCursor: followCursor, triggerClassName: triggerClassName, portalClassName: classNames__default['default']({
...
const Popover = (_a) => {
    var { closeOnEscape, closeOnBodyClick, trigger, leaveDelay, children, content, className, disablePadding, popoverStyle, popoverClassName } = _a, rest = __rest(_a, ["closeOnEscape", "closeOnBodyClick", "trigger", "leaveDelay", "children", "content", "className", "disablePadding", "popoverStyle", "popoverClassName"]);
    const id = rdk.useId();
