...
export declare const computeCellPositions: ({ direction, colorScale, emptyColor, from, to, data, cellWidth, cellHeight, daySpacing, offset, }: ComputeCellPositions) => ({
    coordinates: {
        x: number;
        y: number;
    };
...
export declare const computeWeekdays: ({ cellHeight, cellWidth, direction, daySpacing, ticks, arrayOfWeekdays, }: ComputeWeekdays) => {
    value: string;
    rotation: number;
    y: number;
    x: number;
