...
function FourThousandHours() {
    ...
    const FourThousandHoursAccomplished = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>4000 hours</h4>
            <i class="fa-solid fa-trophy fa-2x four-thousand-hours-done"></i>
            <p>Accomplished</p>
            </>
        )
    }

    const FourThousandHoursLocked = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>4000 hours</h4>
            <i class="fa-solid fa-trophy fa-2x four-thousand-hours-locked"></i>
            <p><i class="fa-solid fa-lock"></i> Locked</p>
            </>
        )
    }

    if (totalTimeStudied < 4000) {
        return <FourThousandHoursLocked />
    } else {
        return <FourThousandHoursAccomplished />
    }
}

export default FourThousandHours;