...
function SixHundredHours() {
    ...
    const SixHundredHoursAccomplished = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>600 hours</h4>
            <i class="fa-solid fa-award fa-2x six-hundred-hours-done"></i>
            <p>Accomplished</p>
            </>
        )
    }

    const SixHundredHoursLocked = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>600 hours</h4>
            <i class="fa-solid fa-award fa-2x six-hundred-hours-locked"></i>
            <p><i class="fa-solid fa-lock"></i> Locked</p>
            </>
        )
    }

    if (totalTimeStudied < 600) {
        return <SixHundredHoursLocked />
    } else {
        return <SixHundredHoursAccomplished />
    }
}

export default SixHundredHours;