...
function FourHundredHours() {
    ...
    const FourHundredHoursAccomplished = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>400 hours</h4>
            <i class="fa-solid fa-star fa-2x four-hundred-hours-done"></i>
            <p>Accomplished</p>
            </>
        )
    }

    const FourHundredHoursLocked = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>400 hours</h4>
            <i class="fa-solid fa-star fa-2x four-hundred-hours-locked"></i>
            <p><i class="fa-solid fa-lock"></i> Locked</p>
            </>
        )
    }

    if (totalTimeStudied < 400) {
        return <FourHundredHoursLocked />
    } else {
        return <FourHundredHoursAccomplished />
    }
}

export default FourHundredHours;