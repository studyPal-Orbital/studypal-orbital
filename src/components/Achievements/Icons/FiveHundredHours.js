...
function FiveHundredHours() {
    ...
    const FiveHundredHoursAccomplished = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>500 hours</h4>
            <i class="fa-solid fa-award fa-2x five-hundred-hours-done"></i>
            <p>Accomplished</p>
            </>
        )
    }

    const FiveHundredHoursLocked = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>500 hours</h4>
            <i class="fa-solid fa-award fa-2x five-hundred-hours-locked"></i>
            <p><i class="fa-solid fa-lock"></i> Locked</p>
            </>
        )
    }

    if (totalTimeStudied < 500) {
        return <FiveHundredHoursLocked />
    } else {
        return <FiveHundredHoursAccomplished />
    }
}

export default FiveHundredHours;