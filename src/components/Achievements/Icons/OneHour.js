...
function OneHour() {
    ...
    const OneHourLocked = () => {
        return (
            ...
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>1 hour</h4>
            <i class="fa-solid fa-thumbs-up fa-2x one-hour-locked"></i>
            <p><i class="fa-solid fa-lock"></i> Locked</p>
            </>
        )
    }

    if (totalTimeStudied < 1) {
        return <OneHourLocked />
    } else {
        return <OneHourAccomplished />
    }
}
