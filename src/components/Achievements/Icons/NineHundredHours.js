...
function NineHundredHours() {
    ...
    const NineHundredHoursAccomplished = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>900 hours</h4>
            <i class="fa-solid fa-medal fa-2x nine-hundred-hours-done"></i>
            <p>Accomplished</p>
            </>
        )
    }

    const NineHundredHoursLocked = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>900 hours</h4>
            <i class="fa-solid fa-medal fa-2x nine-hundred-hours-locked"></i>
            <p><i class="fa-solid fa-lock"></i> Locked</p>
            </>
        )
    }

    if (totalTimeStudied < 900) {
        return <NineHundredHoursLocked />
    } else {
        return <NineHundredHoursAccomplished />
    }
}

export default NineHundredHours;