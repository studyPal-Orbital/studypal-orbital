...
function OneThousandHours() {
    ...
    const OneThousandHoursAccomplished = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>1000 hours</h4>
            <i class="fa-solid fa-medal fa-2x one-thousand-hours-done"></i>
            <p>Accomplished</p>
            </>
        )
    }

    const OneThousandHoursLocked = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>1000 hours</h4>
            <i class="fa-solid fa-medal fa-2x one-thousand-hours-locked"></i>
            <p><i class="fa-solid fa-lock"></i> Locked</p>
            </>
        )
    }

    if (totalTimeStudied < 1000) {
        return <OneThousandHoursLocked />
    } else {
        return <OneThousandHoursAccomplished />
    }
}

export default OneThousandHours;