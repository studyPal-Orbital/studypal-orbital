...
function ThreeThousandHours() {
    ...
    const ThreeThousandHoursAccomplished = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>3000 hours</h4>
            <i class="fa-solid fa-trophy fa-2x three-thousand-hours-done"></i>
            <p>Accomplished</p>
            </>
        )
    }

    const ThreeThousandHoursLocked = () => {
        return (
            <>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v6.1.1/css/all.css" crossorigin="anonymous"></link>
            <h4>3000 hours</h4>
            <i class="fa-solid fa-trophy fa-2x three-thousand-hours-locked"></i>
            <p><i class="fa-solid fa-lock"></i> Locked</p>
            </>
        )
    }

    if (totalTimeStudied < 3000) {
        return <ThreeThousandHoursLocked />
    } else {
        return <ThreeThousandHoursAccomplished />
    }
}

export default ThreeThousandHours;